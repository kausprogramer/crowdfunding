          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                Kos-Crypt <br className="hidden md:block" />
                Crowd Funding KC
              </h2>
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
              This crowdfunding application leverages React and Ethereum's blockchain to facilitate the creation and management of fundraising campaigns. Users can connect their MetaMask wallet, create campaigns, donate, and track donations. The application ensures transparency, security, and efficiency in managing and supporting various funding initiatives.
              </p>
              <a
                href="/"
                aria-label=""
